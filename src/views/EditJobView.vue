...
// handle form submit for update job
...
<template>
    <section class="bg-green-50">
        ...
        <div v-else-if="state.error" class="text-center text-gray-500 py-12">
            <p class="text-red-500">No Job Found</p>
            <p class="text-red-500">{{ state.error }}</p>
        </div>
        <!-- Show job form if error is null and loading is false -->
            ...
            <div class="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
                <form @submit.prevent="handleSubmit">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="type" name="type" v-model="form.type" class="border rounded w-full py-2 px-3"
                            required>
